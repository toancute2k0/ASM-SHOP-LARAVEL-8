        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <a class="a_css" href="{{route('product.index')}}">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <a class="a_css" href="{{route('user.index')}}">
                <div class="info-box-content">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <a class="a_css" href="{{route('category.index')}}">
                <div class="info-box-content">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-shopping-basket" style="color: white;"></i></span>
