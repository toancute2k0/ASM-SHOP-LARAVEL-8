...
@section('content')
    ...
    <section class="blog-details-hero set-bg" data-setbg="{{url('public/client')}}/img/blog/details/details-hero.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 order-md-1 order-1">
                    <div class="blog__details__text">
                        <img src="{{url('public/client')}}/img/blog/details/details-pic.jpg" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="blog__details__author">
                                    <div class="blog__details__author__pic">
                                        <img src="{{url('public/client')}}/img/blog/details/details-author.jpg" alt="">
                                    </div>
