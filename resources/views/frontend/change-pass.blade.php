                    ...
                    <div class="vertical_wrap">
                        ...
                        <div class="vertical_bar">
                            ...
                            <ul class="menu" style="display: block;">
                                ...
                                <li><a href="{{route('manager.getPass')}}" class="active">
                    ...
                    <div class="main_container">
                        ...
                        <div class="container">
                            <div class="content tab-content">
                                {{-- <div class="item tab-pane active" id="home">
                                ...
                                <div  class="item">
                                    <form action="{{route('manager.updatePass')}}" method="post" role="form" enctype="multipart/form-data"> @csrf
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
